...
public class Util {
    ...
    public static native String byteMasterPrivateKeyToBTC_Address(byte[] masterKey, long index) throws Throwable; //TODO
    public static native byte[] byteMasterPrivateKeyToMasterPublicKey(byte[] masterKey) throws Throwable;
    public static native String byteMasterPublicKeyToBTC_Address(byte[] publicKey, long index) throws Throwable;// TODO
}
